...
//        Order merchant = Order.builder().name("有鱼记账").build();
...
//
//        OrderReq orderReq = createPaymentReq();
//        paymentService.doPay(orderReq);
//        System.out.println("11");
//    }
//
//    private OrderReq createPaymentReq() {
//
//        OrderReq orderReq = OrderReq.builder().clientName("熊成威").orderAmount(new BigDecimal(1000)).merchantId(merchantPayemtOrgAccount.getMerchant().getId()).paymentChannelCode(paymentChannelCode).build();
//        return orderReq;
//    }
//
//
